...
if __name__=='__main__':
    ...
    straddle_ce_symbol = get_symbols(next_expiry.date(), INSTRUMENT_NAME, atm_strike_price+constants.STRIKE_SELL_DIFF, 'CE')
    straddle_pe_symbol = get_symbols(next_expiry.date(), INSTRUMENT_NAME, atm_strike_price-constants.STRIKE_SELL_DIFF, 'PE')
